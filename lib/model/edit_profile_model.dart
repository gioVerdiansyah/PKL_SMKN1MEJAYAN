...
class EditProfileModel {
  static Future sendPost(
      String oldPass, String confirmPass, String newPass, List<PlatformFile>? bukti, String newPhone, String
      newPhoneParent, String newEmail, String newAddress)
  async {
    try {
      var request = http.MultipartRequest(
          'POST', Uri.parse("${ApiRoute.editProfileRoute}/${GetStorage().read('dataLogin')['user']['id']}"));
      ...
      request.fields['no_hp_ortu'] = newPhoneParent;
      request.fields['email'] = newEmail;
      request.fields['alamat'] = newAddress;
