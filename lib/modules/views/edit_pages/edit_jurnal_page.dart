                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  const Center(
                                    child:
                                        Text('Edit Jurnal', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                                  ),
                                  Column(
                                    children: [
                                      const Padding(
                                        padding: EdgeInsets.symmetric(vertical: 5),
                                        child: Text("Gambar jurnal Sebelumnya",
                                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
                                      ),
                                      (dataJurnal['bukti'] == null)
                                          ? const Text('No Image...')
                                          : FadeInImage(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          if (_formKey.currentState?.saveAndValidate() ?? false) {
                                            ...
                                            var response = await JurnalModel.editJurnal(
                                                widget.idJurnal, kegiatanController.text, buktiController);
                                            if (response['success']) {
                                              if (context.mounted) {
                                                ArtSweetAlert.show(
                                                    context: context,
